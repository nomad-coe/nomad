...
test('list of codes renders correctly', async () => {
  ...
  const list = /Atomistic codes: ABACUS, ABINIT, AMS, ASAP, Amber, BigDFT, CASTEP, CHARMM, CP2K, CPMD, CRYSTAL, DFTB\+, DL_POLY, DMol3, Elk, FHI-aims, FLEUR, FPLO, GAMESS, GPAW, GROMACS, GROMOS, GULP, Gaussian, LAMMPS, MOPAC, Molcas, NAMD, NWChem, OCEAN, ONETEP, ORCA, Octopus, OpenMX, Psi4, Qball, Qbox, QuantumATK, QuantumESPRESSO, SIESTA, TURBOMOLE, Tinker, VASP, WIEN2k, Wannier90, YAMBO, exciting, libAtoms, soliddmft, w2dynamics, Workflow managers: AFLOW, ASR, Atomate, ElaStic, FHI-vibes, LOBSTER, MOFStructures, QuantumESPRESSOXSpectra, QuantumEspressPhonon, QuantumEspressoEPW, phonopy, Database managers: EELSDB, NeXus, OpenKIM$/
