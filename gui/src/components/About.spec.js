...
test('list of codes renders correctly', async () => {
  ...
  const list = /Atomistic codes: ABACUS, ABINIT, AMS, ASAP, Amber, BigDFT, BOPfox, CASTEP, CHARMM, CP2K, CPMD, CRYSTAL, DFTB\+, DL_POLY, DMol3, Elk, FHI-aims, FLEUR, FPLO, GAMESS, GPAW, GROMACS, GROMOS, GULP, Gaussian, LAMMPS, MOPAC, Molcas, NAMD, NWChem, ONETEP, ORCA, Octopus, OpenMX, Psi4, Qball, Qbox, QuantumATK, QuantumESPRESSO, SIESTA, TURBOMOLE, Tinker, VASP, WIEN2k, Wannier90, YAMBO, exciting, libAtoms, Workflow managers: AFLOW, ASR, Atomate, ElaStic, FHI-vibes, LOBSTER, MOFStructures, QuantumEspressPhonon, QuantumEspressoEPW, phonopy, Database managers: EELSDB, NeXus, OpenKIM$/
