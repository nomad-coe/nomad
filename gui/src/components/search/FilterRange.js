...
const RangeQuery = React.memo(({
  ...
  return <div className={clsx(className, styles.root)} data-testid={testID}>
    ...
    <Typography className={styles.dash} variant="body1">-</Typography>
    <TextField className={styles.rangeInput} margin='dense' size='small' variant='outlined' label="max"/>
