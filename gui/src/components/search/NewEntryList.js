...
export class NewEntryListUnstyled extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    const columns = this.props.columns || {
      ...searchResultColumns,
      ...NewEntryListUnstyled.defaultColumns
    }

    let selectedColumns = this.props.selectedColumns
    if (!selectedColumns) {
      selectedColumns = [...defaultSearchResultColumns]
...
const NewEntryList = compose(
  withRouter,
  withApi(false, false),
  withStyles(NewEntryListUnstyled.styles))(NewEntryListUnstyled)
