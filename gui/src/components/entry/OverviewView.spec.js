...
test('correctly renders metadata and all properties', async () => {
  ...
  expect(screen.getByText('xc functional type')).toBeInTheDocument()
  expect(screen.getByText('xc functional names')).toBeInTheDocument()
  expect(screen.getByText('basis set type')).toBeInTheDocument()
  expect(screen.getByText('basis set name')).toBeInTheDocument()
  expect(screen.getByText('van der Waals method')).toBeInTheDocument()
  expect(screen.getByText('relativity method')).toBeInTheDocument()

  expect(screen.getByText('datasets')).toBeInTheDocument()
  expect(screen.getByText('comment')).toBeInTheDocument()
  expect(screen.getByText('references')).toBeInTheDocument()
  expect(screen.getByText('authors')).toBeInTheDocument()
  expect(screen.getByText('mainfile')).toBeInTheDocument()
  ...
  expect(screen.getByText('processing version')).toBeInTheDocument()

  expect(screen.getByText('formula')).toBeInTheDocument()
  expect(screen.getByText('structural type')).toBeInTheDocument()
  expect(screen.getByText('material name')).toBeInTheDocument()
  expect(screen.getByText('crystal system')).toBeInTheDocument()
