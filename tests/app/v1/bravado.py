...
class FastApiTestHttpClient(HttpClient):
    def __init__(self, fastapi_test_client, headers={}):
        self._fastapi_client = fastapi_test_client
    ...
    def request(self, request_params, *args, **kwargs):
        ...
        test_future = FastApiTestFutureAdapter(request_params, self._fastapi_client)

        return HttpFuture(test_future, FastApiTestResponseAdapter, *args, **kwargs)


class FastApiTestFutureAdapter:
    '''
    ...
    def __init__(self, request_params, fastapi_client, response_encoding='utf-8'):
    ...
    def result(self, **_):
        ...
        function = getattr(self._fastapi_client, method.lower())
...
class FastApiTestResponseAdapter(IncomingResponse):
    '''
    ...
    Args:
        fastapi_response: Response to a call simulated with fastapi's test client.
    '''
