export NOMAD_CLIENT_URL=http://repository.nomad-coe.eu/uploads/api
...
export NOMAD_REPOSITORY_DB_DBNAME=nomad_prod
export NOMAD_REPOSITORY_DB_HOST=db-repository-nomad.esc
export NOMAD_REPOSITORY_DB_USER=nomadrep
