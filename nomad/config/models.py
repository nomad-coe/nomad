        ...
        Entry(**{
            'cards': {
                ...
                'options': {
                    ...
                    'spectroscopic': {'error': 'Could not render spectroscopic properties.'},
            ...
            'options': {
                'entries': {
                    ...
                    'columns': {
                        ...
                        'options': {
                            ...
                            'results.method.simulation.precision.native_tier': {'label': 'Code-specific tier'},
                            'results.method.simulation.precision.planewave_cutoff': {'label': 'Plane-wave cutoff'},
                ...
                'eels': {
                    ...
                    'columns': {
                        ...
                        'options': {
                            'results.material.chemical_formula_hill': {'label': 'Formula', 'align': 'left'},
                            'results.properties.spectroscopic.spectra.provenance.eels.detector_type': {'label': 'Detector type'},
                            'results.properties.spectroscopic.spectra.provenance.eels.resolution': {'label': 'Resolution'},
                            'upload_create_time': {'label': 'Upload time', 'align': 'left'},
                            'authors': {'label': 'Authors', 'align': 'left'},
