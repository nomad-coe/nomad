...
parsers = [
    ...
    MatchingParserInterface(
        'electronicparsers.castep.parser.CastepParser',
    ...
    MatchingParserInterface(
        'electronicparsers.charmm.parser.CharmmParser',
    ...
    MatchingParserInterface(
        'electronicparsers.cp2k.parser.CP2KParser',
    ...
    MatchingParserInterface(
        'electronicparsers.cpmd.parser.CPMDParser',
        metadata_path=f'{prefix_electronic}/cpmd/metadata.yaml',
        mainfile_contents_re=(r'\*\*\*       \*\*   \*\*\*  \*\* \*\*\*\* \*\*  \*\*   \*\*\*')
    ),
    MatchingParserInterface(
        'electronicparsers.crystal.parser.CrystalParser',
        metadata_path=f'{prefix_electronic}/crystal/metadata.yaml',
        mainfile_contents_re=(
            fr'(\r?\n \*\s+CRYSTAL[\d]+\s+\*\r?\n \*\s*[a-zA-Z]+ : \d+[\.\d+]*)')
    ),
    MatchingParserInterface(
        'electronicparsers.dmol3.parser.Dmol3Parser',
    ...
    MatchingParserInterface(
        'electronicparsers.fhiaims.parser.FHIAimsParser',
    ...
    MatchingParserInterface(
        'electronicparsers.fleur.parser.FleurParser',
    ...
    MatchingParserInterface(
        'electronicparsers.fplo.parser.FploParser',
    ...
    MatchingParserInterface(
        'electronicparsers.gamess.parser.GamessParser',
    ...
    MatchingParserInterface(
        'electronicparsers.gaussian.parser.GaussianParser',
    ...
    MatchingParserInterface(
        'electronicparsers.gpaw.parser.GPAWParser',
    ...
    MatchingParserInterface(
        'electronicparsers.orca.parser.OrcaParser',
    ...
    MatchingParserInterface(
        'electronicparsers.psi4.parser.Psi4Parser',
    ...
    MatchingParserInterface(
        'electronicparsers.quantumespresso.parser.QuantumEspressoParser',
    ...
    MatchingParserInterface(
        'electronicparsers.siesta.parser.SiestaParser',
    ...
    MatchingParserInterface(
        'electronicparsers.wien2k.parser.Wien2kParser',
    ...
    MatchingParserInterface(
        'workflowparsers.asr.parser.ASRParser',
    ...
    MatchingParserInterface(
        'workflowparsers.elastic.parser.ElasticParser',
    ...
    MatchingParserInterface(
        'workflowparsers.phonopy.parser.PhonopyParser',
    ...
    MatchingParserInterface(
        'workflowparsers.mofstructures.parser.MOFStructuresParser',
    ...
    MatchingParserInterface(
        'workflowparsers.quantum_espresso_phonon.QuantumEspressoPhononParser',
    ...
    MatchingParserInterface(
        'workflowparsers.quantum_espresso_epw.QuantumEspressoEPWParser',
    ...
    MatchingParserInterface(
        'electronicparsers.wannier90.parser.Wannier90Parser',
        metadata_path=f'{prefix_electronic}/wannier90/metadata.yaml',
        mainfile_contents_re=r'\|\s*WANNIER90\s*\|'
    ),
    MatchingParserInterface(
        'electronicparsers.w2dynamics.parser.W2DynamicsParser',
    ...
    MatchingParserInterface(
        'electronicparsers.soliddmft.parser.SolidDMFTParser',
...
parsers = [
    ...
    if config.parsing.parsers.filter(parser.name)
]
